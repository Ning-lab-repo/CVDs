...
# The description of codes  
  ...
  Bar plot.py  Stacked bar charts show the proportion of different groups within each ICD10 code.  
  ...
  UMAP.py  This code performs UMAP dimensionality reduction on samples, visualizing the distribution of the population in a lower-dimensional space.
